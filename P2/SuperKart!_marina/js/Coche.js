class Coche {
  ...
  constructor(scene) {
    ...
    this.box_container.add(this.meshCoche);
  ...
  createCoche(scene) {
    ...
    this.input;
    this.meshCoche = new THREE.Object3D();
    ...
    this.meshCoche.add(this.ruedaDelante);
    
    
    this.meshCoche.position.set(0, -10, 0);
    ...
    for ( var i = 0; i < 4; i++ ) {
      this.coche.addWheel(
        ...
        new THREE.Vector3(
            i % 2 === 0 ? -1.3 : 1.3, 
            -0.3, // Altura ruedas
            i < 2 ? 1 : -1    // Como de separadas estan las ruedas
        ),
  ...
  update() {
    ...
    console.log(this.coche.mesh.rotation.x);
