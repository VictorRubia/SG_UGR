class MyPhysiScene extends Physijs.Scene {
  ...
  createCamera() {
    ...
    this.camera.position.set (30, 25, 10);
  ...
  getCamera() {
    ...
    var relativeCameraOffset = new THREE.Vector3(0,40,-45);
    this.coche.coche.mesh.matrixWorldNeedsUpdate = false;
    var cameraOffset = relativeCameraOffset.applyMatrix4(this.coche.coche.mesh.matrixWorld);
    this.camera.position.z = cameraOffset.z;
    this.camera.position.x = cameraOffset.x;
    // this.camera.position.z = this.coche.coche.mesh.position.z + 25;
    // this.camera.position.x = this.coche.coche.mesh.position.x;
    // this.camera.position.x = this.coche.coche.mesh._physijs.position.x;
