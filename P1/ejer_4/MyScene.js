...
class MyScene extends THREE.Scene {
  ...
  constructor (myCanvas) { 
    ...
    this.columnaCorazon = new ColumnaCorazon(this.gui, "Controles Trebol");
    this.columnaCorazon_ = new THREE.Object3D();
    this.columnaCorazon_.add(this.columnaCorazon);
    this.columnaCorazon_.position.x -= 12;
    this.add(this.columnaCorazon_);

    this.columnaTrebol = new ColumnaTrebol(this.gui, "Controles Trebol");
    this.columnaTrebol_ = new THREE.Object3D();
    this.columnaTrebol_.add(this.columnaTrebol);
    this.columnaTrebol_.position.x += 12;
    this.add(this.columnaTrebol_);
  ...
  createGUI () {
    ...
    gui.add(this.guiControls, 'animacion').name ('Animacion : ');
